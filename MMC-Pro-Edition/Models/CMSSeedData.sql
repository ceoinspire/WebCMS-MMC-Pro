...
--Values(2,'admin@fanco.com.pk','Xz/ian5HsLvMBVVePSw3pg==',1,GETDATE(),0,GETDATE())
...
--VALUES
--    (1,1001, 'https://inspirecms.fanco.com.pk', 1, '46FA7C94-8CC9-4DD5-BC76-A8DE35736986', 'WebCms');
    
--INSERT INTO System.Settings
--    (SettingsId,ApplicationId, ApplicationURL, IsActive, BranchId, ApplicationName)
--VALUES
--    (2,1002, 'https://staging.ecommerce.inspirenation.us', 0, '46FA7C94-8CC9-4DD5-BC76-A8DE35736986', 'Store Admin');
